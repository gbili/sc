 ...
 */
class TranslatedPost extends \Blog\Entity\TranslatedPost implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TranslatedPost $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addTranslation(\Blog\Entity\Post $translation)
    {
